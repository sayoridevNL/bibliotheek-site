...
<body>
    ...
    <div class="boek-detail">
        ...
        if (isset($_GET['id'])) {
            ...
            if (isset($_POST['leen'])) { // when 'borrow/leen' btn is clicked
            ...
            if ($boek) {
                ...
                if (!$uitgeleend){
                    ...
                    echo "<button class='leen-button' '>Leen dit boek</button>";
                    echo "</form>";
                }else {
                    echo "<button class='leen-button' disabled>Dit boek is momenteel uitgeleend</button>";
                }
            } else { // if book doesn't exist
                echo "<p>Boek niet gevonden.</p>"; // error msg
            }
        } else { 
            echo "<p>Geen boek geselecteerd.</p>"; // error msg
        }
        ...
        if ($_SERVER['REQUEST METHOD'] === 'POST'){
            echo "<form method='POST'>
                ...
                <button type='submit' name='leen' class='leen-button'>
                    Leen dit boek
                </button>
            </form>
            ";
